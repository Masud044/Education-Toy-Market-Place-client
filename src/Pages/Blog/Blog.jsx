...
const Blog = () => {
    return (
        <div className="mt-10">
            ...
            <div className=" border-2 border-fuchsia-800 p-4">
                <h1 className="font-bold text-fuchsia-600 mb-4">Compare SQL and NoSQL databases?</h1>
            ...
            <div className=" border-2 border-fuchsia-800 p-4">
                <h1 className="font-bold text-fuchsia-600 mb-4">What is express js? What is Nest JS (google it)?</h1>
            ...
            <div className=" border-2 border-fuchsia-800 p-4">
                <h1 className="font-bold text-fuchsia-600 mb-4">What is MongoDB aggregate and how does it work (google it)?</h1>
